...
requerem dois tipos de recursos: mão-de-obra e materiais. A empresa fabrica três
tipos de incenso, cada qual com diferentes necessidades de mão-de-obra e
...
A disponiblidade de materiasi é de 200 g/dia. A mão de obra disponivel por dia
é de 150 horas. Formule um problema de programação linear para determinar quanto
deve ser produzido de cada tipo de incenso, tal que o lucro total seja maximizado.

# PASSO 1 - IDENTIFICAÇÃO DAS VARIAVEIS DE DECISÃO
# XA, XB, XC = PRODUÇÃO DIARIA DOS TIPOS DE INCENSO

#PASSO 2 - INDENTIFICAÇÃO DAS RESTRIÇÕES
# 7XA = O TIPO A DE INCENSO LEVA 7 HORAS PARA SER PRODUZIDO
# 3XB = O TIPO B DE INCENSO LEVA 3 HORAS PARA SER PRODUZIDO
# 6XC = O TIPO C CE INCENSO LEVA 6 HORAS PARA SER PRODUZIDO

# RESTRIÇÃO RELACIONADA MÃO DE OBRA
# 7XA + 3XB + 6XC <= 150 (A QUANTIDADE DE HORAS QUE NÃO PODE SER EXCEDIDAS)

# RESTRIÇÃO RELACIONADA A MATERIAS
# 4XA + 4XB + 5XB <= 200 (A QUATIDADE DE MATERIAL DISPONIVEL AO DIA)

# PASSO 3 - IDENTIFICAÇÃO DO OBJETIVO
# MAXIMIZAR O LUCRO TOTAL ORIUNDO DA VENDA DOS PRODUTOS
# z = 4XA + 2XB + 3XC
# XA, XB, XC >= 0
**/
...
public class Mix_producao {
	...
	public static void main(String[] args) {
		...
		System.out.print("A produção diaria de incenso dos tipos A, B e C foi de: "+ XA +" un "+ XB +" un "+ XC +" un");	
		System.out.println();
