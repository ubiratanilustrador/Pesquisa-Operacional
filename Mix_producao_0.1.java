 ...
 * Materiais (g/por unidade produzida)  | 4 | 4 | 5 | 
 * Lucro ($/unidade)                    | 4 | 2 | 3 |
 * 
 ...
 * 
 * RESTRIÇÃO RELACIONADA MÃO DE OBRA # 7XA + 3XB + 6XC <= 150 
 * (A QUANTIDADE DE HORAS QUE NÃO PODE SER EXCEDIDAS)
 * 
 * RESTRIÇÃO RELACIONADA A MATERIAS # 4XA + 4XB + 5XB <= 200 
 * (A QUATIDADE DE MATERIAL DISPONIVEL AO DIA)
 * 
 * PASSO 3 - IDENTIFICAÇÃO DO OBJETIVO: MAXIMIZAR O LUCRO TOTAL ORIUNDO 
 * DA VENDA DOS PRODUTOS Z = 4XA + 2XB + 3XC # XA, XB, XC >= 0
 **/
...
public class Mix_producao {
	public static void main(String[] args) {
		...
		try (Scanner sc2 = new Scanner(System.in)) {
			// PRODUÇÃO DIARIA DOS TIPOS DE INCENSO 6,5,4
			System.out.println( "DIGITE UM VALOR PARA PRODUÇÃO DE INCESO DO TIPO A, MAIOR OU IGUAL 0:");
			int XA = sc2.nextInt();
			System.out.println( "DIGITE UM VALOR PARA PRODUÇÃO DE INCESO DO TIPO B, MAIOR OU IGUAL 0:");
			int XB = sc2.nextInt();
			System.out.println( "DIGITE UM VALOR PARA PRODUÇÃO DE INCESO DO TIPO C, MAIOR OU IGUAL 0:");
			int XC = sc2.nextInt();
		
			System.out.println();
			
			//EXIBI A QUANTIDADE DE INCENSO NO PROMPT NECESSARIA 
			System.out.print(
					"A produção diaria de incenso dos tipos A, B e C foi de: " + XA + " un " + XB + " un " + XC + " un");
			System.out.println();
			
			//RESTRIÇÃO DE HORAS DE MÃO DE OBRA TRABALHADA 
			...
			//RESTRIÇÃO DE GRAMAS DE MATERIA PRIMA NECESSARIA NA PRODUÇÃO 
			...
			//OBJETIVO MAXIMIZAR O LUCRO OBTIDO NA VENDA DO INCENSO
	...
	//FUNÇÃO RESPONSÁVEL POR CALCULAR RESTRIÇÃO DE HORAS TRABALHADAS
	...
	//FUNÇÃO RESPONSÁVEL POR CALCULAR RESTRIÇÃO DE MATERIA PRIMA USADA NO PROCESSO
	...
	//FUNÇÃO RESPONSÁVEL POR CALCULAR OBJETIVO: MAXIMIZAR O LUCRO DA VENDA DE INCENSOS
